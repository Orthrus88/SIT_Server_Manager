...
exports.BearTrader = void 0;
const ConfigTypes_1 = require("C:/snapshot/project/obj/models/enums/ConfigTypes");
// New trader settings
const Money_1 = require("C:/snapshot/project/obj/models/enums/Money");
const baseJson = __importStar(require("../../Traders/db/BearTraderBase.json"));
...
class BearTrader {
    ...
    preAkiLoad(container) {
        ...
        this.traderHelper.registerProfileImage(baseJson, this.mod, preAkiModLoader, imageRouter, "bear.jpg");
    ...
    postDBLoad(container) {
        ...
        this.traderHelper.addTraderToLocales(baseJson, tables, baseJson.name, "Bear Trader", baseJson.nickname, baseJson.location, "");
    }
}
exports.BearTrader = BearTrader;
//# sourceMappingURL=BearTrader.js.map