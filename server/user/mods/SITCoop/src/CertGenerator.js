...
class CertGenerator {
    ...
    generate(serverIp) {
        ...
        let generatedResult;
        generatedResult = selfsigned_1.default.generate(null, {
            keySize: 2048,
            days: 365,
            algorithm: "sha256",
            extensions: [{ name: "commonName", cA: true, value: serverIp + "/" }],
            pkcs7: true,
...
exports.CertGenerator = CertGenerator;
