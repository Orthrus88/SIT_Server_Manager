...
class BSPMain implements IPostDBLoadMod, IPostAkiLoadMod {
                                ...
                                if (settingsLocations.enabled) {
                                    ...
                                    for (const locations in this.locationNames) {
                                        ...
                                        if (settingsManager.globalOverrides.enabled) {
                                            tryCatchWrapper(() => bspClassLocations.botChanceDifficultyOverrides(settingsManager, initJson), "bot chance and difficulty global override");
